...
**Репозиторий (полный проект):** [github.com/Ekaterina-Kotendzhi/PPC-1](https://github.com/Ekaterina-Kotendzhi/PPC-1)

Код, backend, frontend, тесты и запуск — в репозитории на GitHub.  
Эта папка — копии ключевых файлов (`.env.example`, Docker, `tests_data`) и краткая документация; для работы клонируйте репозиторий.
